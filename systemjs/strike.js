...
System.register("Util", [], function(exports_1, context_1) {
    ...
    exports_1("extractArgumentsFromFunction", extractArgumentsFromFunction);
    /**
    ...
    exports_1("createFormatter", createFormatter);
    /**
     *
     *
     * @export
...
System.register("Reducer", [], function(exports_2, context_2) {
    "use strict";
...
System.register("Middleware", [], function(exports_3, context_3) {
    "use strict";
...
System.register("Combiner", [], function(exports_4, context_4) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_4("Combiner", Combiner);
        }
    }
});
System.register("Pool", [], function(exports_5, context_5) {
    "use strict";
    ...
    exports_5("createPool", createPool);
    return {
        setters:[],
        execute: function() {
        }
...
System.register("StatefulComponent", [], function(exports_6, context_6) {
    "use strict";
...
System.register("Store", ["Combiner", "Pool", 'immutable'], function(exports_7, context_7) {
    "use strict";
    var __moduleName = context_7 && context_7.id;
    var Combiner_1, Pool_1, Immutable;
    var ChangeStatus, Store;
    ...
    return {
        setters:[
            function (Combiner_1_1) {
                Combiner_1 = Combiner_1_1;
            },
            function (Pool_1_1) {
                Pool_1 = Pool_1_1;
            },
        ...
        execute: function() {
            ...
            exports_7("Store", Store);
        }
    }
});
System.register("Action", [], function(exports_8, context_8) {
    "use strict";
...
System.register("ControllerView", ['react'], function(exports_9, context_9) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_9("ControllerView", ControllerView);
        }
    }
});
System.register("Injector", ["Util"], function(exports_10, context_10) {
    'use strict';
    ...
    return {
        ...
        execute: function() {
            ...
            exports_10("Injector", Injector);
            exports_10("default",Injector);
        }
    }
});
System.register("Router", ['react', 'react-dom', "Util"], function(exports_11, context_11) {
    "use strict";
    var __moduleName = context_11 && context_11.id;
    var React, ReactDOM, Util_2;
    var TYPES_TO_REGEX, TYPES_TO_PARSE, HashChangeStrategy, Router;
    ...
    return {
        ...
        execute: function() {
            ...
            exports_11("Router", Router);
        }
    }
});
System.register("Example", ['react', "Store", "ControllerView", "Injector", 'immutable', "Router"], function(exports_12, context_12) {
    "use strict";
    var __moduleName = context_12 && context_12.id;
    var React, Store_1, ControllerView_1, Injector_1, Immutable, Router_1;
    ...
    return {
        setters:[
            ...
            function (ControllerView_1_1) {
                ControllerView_1 = ControllerView_1_1;
            },
            function (Injector_1_1) {
                Injector_1 = Injector_1_1;
            },
            function (Immutable_2) {
                Immutable = Immutable_2;
            },
            function (Router_1_1) {
                Router_1 = Router_1_1;
            }],
        execute: function() {
            ...
            exports_12("Example1", Example1);
            Example2 = (function (_super) {
...
System.register("InjectableMiddleware", [], function(exports_13, context_13) {
    "use strict";
    ...
    exports_13("Injectable", Injectable);
    return {
        setters:[],
        execute: function() {
        }
...
System.register("IntegerPromisifyMiddleware", [], function(exports_14, context_14) {
    "use strict";
    ...
    exports_14("IntegerPromisifer", IntegerPromisifer);
    return {
        setters:[],
        execute: function() {
        }
...
System.register("PromisifyMiddleware", [], function(exports_15, context_15) {
    "use strict";
    ...
    exports_15("Promisify", Promisify);
    return {
        setters:[],
        execute: function() {
        }
...
System.register("WorkerMiddleware", [], function(exports_16, context_16) {
    "use strict";
    ...
    exports_16("WorkerMiddleware", WorkerMiddleware);
    return {
        setters:[],
        execute: function() {
        }
...
System.register("index", ["Combiner", "Store", "Router", "Util", "Injector", "ControllerView", "InjectableMiddleware", "IntegerPromisifyMiddleware", "PromisifyMiddleware", "Pool", "WorkerMiddleware"], function(exports_17, context_17) {
    "use strict";
    var __moduleName = context_17 && context_17.id;
    return {
        setters:[
            function (Combiner_2_1) {
                exports_17({
                    "Combiner": Combiner_2_1["Combiner"]
                });
            },
            function (Store_2_1) {
                exports_17({
                    "Store": Store_2_1["Store"],
                    "StoreOptions": Store_2_1["StoreOptions"],
                    "DispatchFn": Store_2_1["DispatchFn"]
                });
            },
            function (Router_2_1) {
                exports_17({
            ...
            function (Util_3_1) {
                exports_17({
                    "printf": Util_3_1["printf"],
                    "setDataAt": Util_3_1["setDataAt"],
                    "getDataAt": Util_3_1["getDataAt"],
                    "createFormatter": Util_3_1["createFormatter"],
                    "identity": Util_3_1["identity"],
                    "extractArgumentsFromFunction": Util_3_1["extractArgumentsFromFunction"],
                    "format": Util_3_1["format"]
                });
            },
            function (Injector_2_1) {
                exports_17({
                    "Injector": Injector_2_1["Injector"]
                });
            },
            function (ControllerView_2_1) {
                exports_17({
                    "ControllerView": ControllerView_2_1["ControllerView"],
                    "ControllerViewProps": ControllerView_2_1["ControllerViewProps"]
                });
            },
            function (InjectableMiddleware_1_1) {
                exports_17({
                    "Injectable": InjectableMiddleware_1_1["Injectable"]
                });
            },
            function (IntegerPromisifyMiddleware_1_1) {
                exports_17({
                    "IntegerPromisifer": IntegerPromisifyMiddleware_1_1["IntegerPromisifer"]
                });
            },
            function (PromisifyMiddleware_1_1) {
                exports_17({
                    "Promisify": PromisifyMiddleware_1_1["Promisify"]
                });
            },
            function (Pool_2_1) {
                exports_17({
                    "createPool": Pool_2_1["createPool"]
                });
            },
            function (WorkerMiddleware_1_1) {
                exports_17({
                    "WorkerMiddleware": WorkerMiddleware_1_1["WorkerMiddleware"],
                    "WorkerAction": WorkerMiddleware_1_1["WorkerAction"]
                });
            }],
        execute: function() {
        }
