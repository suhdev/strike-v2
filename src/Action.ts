...
export import Action = $strike.Action
export import PromiseAction = $strike.PromiseAction;
export import ServiceAction = $strike.ServiceAction;
export import ServiceFunction = $strike.ServiceFunction;